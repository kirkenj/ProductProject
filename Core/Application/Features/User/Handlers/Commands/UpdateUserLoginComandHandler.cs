...
namespace Application.Features.User.Handlers.Commands
{
    public class UpdateUserLoginComandHandler : IRequestHandler<UpdateUserLoginComand, Response<string>>, IPasswordSettingHandler
    {
        ...
        {
            var user = await userRepository.GetAsync(request.UpdateUserLoginDto.Id);
            ...
            var foundUser = await userRepository.GetAsync(new Models.User.UserFilter() { AccurateLogin = newLogin });
